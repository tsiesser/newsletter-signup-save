...
All of the components are responsive based on breakpoints defined in _breakpoints.scss in the components folder.

Colors and font assignments are defined in _variables.scss in the components folder.

### Scripts
- To run in browser: npm start
